...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['map_id'], ['maps.id'], name=op.f('fk_compounds_map_id_maps'), ondelete='RESTRICT'),
    ...
    sa.ForeignKeyConstraint(['core_gun_id'], ['weapons.id'], name=op.f('fk_weapons_core_gun_id_weapons'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['weapon_type_id'], ['weapon_types.id'], name=op.f('fk_weapons_weapon_type_id_weapon_types'), ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_weapons')),
    sa.UniqueConstraint('name', name=op.f('uq_weapons_name'))
    )
    op.create_table('match_player_data',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['player_id'], ['players.id'], name=op.f('fk_match_player_data_player_id_players'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['slot_a_ammo_a_id'], ['ammo_types.id'], name=op.f('fk_match_player_data_slot_a_ammo_a_id_ammo_types'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['slot_a_ammo_b_id'], ['ammo_types.id'], name=op.f('fk_match_player_data_slot_a_ammo_b_id_ammo_types'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['slot_a_weapon_id'], ['weapons.id'], name=op.f('fk_match_player_data_slot_a_weapon_id_weapons'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['slot_b_ammo_a_id'], ['ammo_types.id'], name=op.f('fk_match_player_data_slot_b_ammo_a_id_ammo_types'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['slot_b_ammo_b_id'], ['ammo_types.id'], name=op.f('fk_match_player_data_slot_b_ammo_b_id_ammo_types'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['slot_b_weapon_id'], ['weapons.id'], name=op.f('fk_match_player_data_slot_b_weapon_id_weapons'), ondelete='RESTRICT'),
    ...
    sa.ForeignKeyConstraint(['map_id'], ['maps.id'], name=op.f('fk_matches_map_id_maps'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['player_1_id'], ['players.id'], name=op.f('fk_matches_player_1_id_players'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['player_1_match_data_id'], ['match_player_data.id'], name=op.f('fk_matches_player_1_match_data_id_match_player_data'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['player_2_id'], ['players.id'], name=op.f('fk_matches_player_2_id_players'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['player_2_match_data_id'], ['match_player_data.id'], name=op.f('fk_matches_player_2_match_data_id_match_player_data'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['player_3_id'], ['players.id'], name=op.f('fk_matches_player_3_id_players'), ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['player_3_match_data_id'], ['match_player_data.id'], name=op.f('fk_matches_player_3_match_data_id_match_player_data'), ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_matches'))
    )
    op.create_table('m2m_fight_locations',
    sa.Column('match_id', sa.Integer(), nullable=False),
    sa.Column('compound_id', sa.Integer(), nullable=False),
    sa.Column('fight_ordering', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['compound_id'], ['compounds.id'], name=op.f('fk_m2m_fight_locations_compound_id_compounds'), onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['match_id'], ['matches.id'], name=op.f('fk_m2m_fight_locations_match_id_matches'), onupdate='CASCADE', ondelete='CASCADE'),
