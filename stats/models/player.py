...
from ..validators import UnicodeUsernameValidator, UnicodeAndSpaceValidator
import hashlib
...
class Player(models.Model):
    ...
    username = models.OneToOneField(
        User,
        # on_delete=models.SET(self.objects.get(username='UnknownHunter').pk),
        on_delete=models.RESTRICT,
        # TODO get rid of 2 lines above, make use of special table, and special boolean key
    ...
    hash_key = models.CharField(
        # It is used to bind non-user profile to real user profile.
    ...
    created_by = models.ForeignKey(
        User,
        verbose_name=_(
            "Showss who is the creator of this player. It's used only while player is not assigned to a user."),
        # on_delete=models.SET(get(username='UnknownHunter').pk),
        on_delete=models.RESTRICT,
        # TODO get rid of 2 lines above, make use of special table, and special boolean key
